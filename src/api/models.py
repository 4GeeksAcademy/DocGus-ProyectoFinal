...
from sqlalchemy import String, Integer, Boolean, Date, DateTime, ForeignKey, Enum, Text, func   # Importa tipos y funciones necesarios para definir columnas y relaciones en la base de datos
